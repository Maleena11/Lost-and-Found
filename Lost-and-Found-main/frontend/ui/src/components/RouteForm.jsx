...
export default function RouteForm({ route, onSaved }) {
  ...
  const handleSubmit = async (e) => {
    ...
    const data = { routeNumber, startLocation, endLocation, distanceKm, status };
    setLoading(true);
    ...
    try {
      ...
      console.error(err);
      setErrorMessage(err.response?.data?.message || "Error saving route. Maybe Route Number already exists?");
    } finally {
      setLoading(false);
    }
  };
