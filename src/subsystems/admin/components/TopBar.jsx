    ...
    <header className="sticky top-0 z-30 bg-white border-b border-gray-200 shadow-sm flex-shrink-0">
      <div className="flex items-center justify-between h-16 px-4 lg:px-6">
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="font-semibold text-gray-800 leading-tight text-base">{title}</h1>
        ...
        <div className="flex items-center gap-2 sm:gap-3">
          <span className="hidden md:flex items-center text-xs text-gray-500 bg-gray-50 px-3 py-1.5 rounded-lg border border-gray-100">
