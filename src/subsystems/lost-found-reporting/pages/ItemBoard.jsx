          ...
          <div className="flex items-center justify-between gap-8">
            ...
            <div className="flex-1">
              <div className="flex items-center gap-2 text-blue-300 text-xs mb-3">
                ...
                <span className="text-white font-medium">Lost & Found Board</span>
              </div>
              <div className="flex items-center gap-3 mb-2">
                <div className="w-10 h-10 bg-white/15 rounded-xl flex items-center justify-center flex-shrink-0">
                  <i className="fas fa-clipboard-list text-white text-lg"></i>
                </div>
                <h1 className="text-3xl font-extrabold tracking-tight">Campus Lost & Found Board</h1>
              </div>
            ...
            {/* Right: CTA Buttons */}
            <div className="hidden lg:flex flex-col flex-shrink-0 gap-3">
              <Link
                to="/report-item"
              ...
              <Link
                to="/notice"
                className="inline-flex items-center gap-2 bg-white/10 hover:bg-white/20 text-white px-5 py-2.5 rounded-xl font-semibold text-sm transition-colors border border-white/20"
              >
