          ...
          <div className="flex items-center justify-between gap-8">
            <div className="flex-1">
              ...
              <div className="flex flex-wrap gap-2.5 mt-5">
                {[
                  { icon: "fa-flag",       text: "Report Type",      color: "text-orange-300" },
                  { icon: "fa-tag",        text: "Item Details",     color: "text-blue-300"   },
                  { icon: "fa-university", text: "Academic Info",    color: "text-violet-300" },
                  { icon: "fa-user",       text: "Contact & Photos", color: "text-emerald-300"},
                ].map(({ icon, text, color }) => (
